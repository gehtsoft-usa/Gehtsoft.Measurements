...
namespace Gehtsoft.Measurements.Test
{
    public class WeightTest
    {
        ...
        [InlineData(1, WeightUnit.Kilogram, 9.80665, WeightUnit.Newton, 1e-5)]
        ...
        [InlineData(1, WeightUnit.USTonne, 2000, WeightUnit.Pound, 1e-5)]
        [InlineData(1, WeightUnit.UKTonne, 2240, WeightUnit.Pound, 1e-5)]
