...
namespace Gehtsoft.Measurements.Test
{
    public class DecimalCoreClassesTest
    {
        ...
        [InlineData(1e-13, TestUnit.Unit1, 1e-13, TestUnit.Unit1, 0)]
        [InlineData(2e-13, TestUnit.Unit1, 1e-13, TestUnit.Unit1, 1)]
        [InlineData(1e-13, TestUnit.Unit1, 2e-13, TestUnit.Unit1, -1)]
